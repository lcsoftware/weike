...
(function ($) {
	...
	view = {
	    ...
	    makeDOMNodeMainBefore: function (html, setting, node) {
	        if (node.level == 0 || node.isParent) {
	            html.push("<li id='", node.tId, "' class='", consts.className.LEVEL, node.level, "' tabindex='0' hidefocus='true' treenode  type=>");
	        }
	        else {
	            html.push("<li id='", node.tId, "' style='display:inline' class='", consts.className.LEVEL, node.level, "' tabindex='0' hidefocus='true' treenode  type=>");
	        }
	    },
	    ...
	    makeNodeLineClass: function (setting, node) {
	        ...
	        if (setting.view.showLine) {
	            ...
	            } else if (!node.isParent && node.level!=0) {
	                lineClass.push(consts.line.NOLINE);
	            } else if (node.isLastNode && node.level == 0) {
	                lineClass.push(consts.line.BOTTOM);
	            } else if (node.getPreNode().isParent) {
