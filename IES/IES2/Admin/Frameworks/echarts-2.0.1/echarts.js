...
function() {
    ...
    var r = window.Event && window.Event.prototype.preventDefault ?
    function(e) {
        e.preventDefault(),
        e.stopPropagation()
    }: function(e) {
...
function(e) {
    ...
    l.prototype.refresh = function(e) {
        ...
        return this._paintList(t),
        typeof e == "function" && e(),
        this
    },
    l.prototype._paintList = function(e) {
        var n = this._getLayerStatus(e),
        s,
        o,
        a = !0,
        f;
    ...
    h.prototype.resize = function(e, t) {
        this.dom.setAttribute("width", e),
        this.dom.setAttribute("height", t),
        this.dom.style.width = e + "px",
        this.dom.style.height = t + "px",
        this.dom.setAttribute("width", e * o),
        this.dom.setAttribute("height", t * o),
        o != 1 && this.ctx.scale(o, o),
        this.domBack && (this.domBack.setAttribute("width", e * o), this.domBack.setAttribute("height", e * o), o != 1 && this.ctxBack.scale(o, o))
    },
...
function(e) {
    function l(e) {
        return function() {
            ...
            if (t.length || e._needsRefreshNextFrame) e.refresh(),
            e._needsRefreshNextFrame = !1
        }
    }
    function c(t, n) {
        this.id = t,
...
define("echarts/chart/gauge", ["require", "../component/base", "./base", "../util/shape/GaugePointer", "zrender/shape/Text", "zrender/shape/Line", "zrender/shape/Rectangle", "zrender/shape/Circle", "zrender/shape/Sector", "../config", "../util/ecData", "zrender/tool/util", "../chart"],
function(e) {
    ...
    return h.prototype = {
        ...
        _buildAxisLabel: function(e) {
            ...
            m,
            g;
            for (var y = 0; y <= n; y++) g = r + s / n * y,
            d = c - h / n * y,
            v = Math.sin(d * Math.PI / 180),
            m = Math.cos(d * Math.PI / 180),
            d = (d + 360) % 360,
            this.shapeList.push(new i({
                zlevel: this._zlevelBase + 1,
                hoverable: !1,
                style: {
                    x: l[0] + m * p,
                    y: l[1] - v * p,
                    color: a == "auto" ? this._getColor(e, g) : a,
                    text: this._getLabelText(t.axisLabel.formatter, g),
                    textAlign: d >= 110 && d <= 250 ? "left": d <= 70 || d >= 290 ? "right": "center",
                    textBaseline: d >= 10 && d <= 170 ? "top": d >= 190 && d <= 350 ? "bottom": "middle",
                    textFont: u,
        ...
        _addAxisLabel: function(e) {
            ...
            for (var g = 0; g < r.length; g++) {
                ...
                if (s.show) {
                    ...
                    v = s.offset || 10;
                    for (var y = 1; y <= l; y++) f = a.merge({},
                    u),
                    p = y * (h.max - h.min) / l + h.min,
                    m && (p = p.toFixed(m)),
                    f.text = this.numAddCommas(p),
                    f.x = y * o[0] / l + Math.cos(d) * v + c[0],
                    f.y = y * o[1] / l + Math.sin(d) * v + c[1],
                    this.shapeList.push(new n({
                        zlevel: this._zlevelBase,
                        style: f,
                        draggable: !1,
...
function e(t) {
    if (typeof window == "undefined" || window !== t) {
        self.tmd = {},
        self.tmd.modules = {},
        self.tmd.require = function(e) {
            return self.tmd.modules[e]
        },
        self.define = function(e, t, n) {
            if (arguments.length === 0) return;
            arguments.length == 1 ? (n = e, e = "ForceLayout") : arguments.length == 2 && (n = t),
            e.indexOf("ForceLayout") >= 0 && (e = "ForceLayout"),
            self.tmd.modules[e] = n(self.tmd.require)
        },
        define("zrender/tool/vector", ["require"],
        function(e) {
            return {
                create: function(e, t) {
        ...
        self.onmessage = function(e) {
            if (e.data instanceof ArrayBuffer) {
                ...
                for (var i = 0; i < r; i++) {
                    var s = n.nodes[i];
                    s.position[0] = t[i * 2 + 1],
                    s.position[1] = t[i * 2 + 2]
                }
                return
            }
            ...
            case "init":
                n || (n = new o),
                n.initNodes(e.data.nodesPosition, e.data.nodesMass, e.data.nodesSize),
                n.initEdges(e.data.edges, e.data.edgesWeight),
                n._token = e.data.token;
                break;
            case "updateConfig":
                if (n) for (var u in e.data.config) n[u] = e.data.config[u];
                break;
            case "update":
                var a = e.data.steps;
                if (n) {
                    var r = n.nodes.length,
                    t = new Float32Array(r * 2 + 1);
                    n.temperature = e.data.temperature;
                    if (e.data.temperature > .01) {
                        for (var i = 0; i < a; i++) n.update(),
                        n.temperature *= e.data.coolDown;
                        for (var i = 0; i < r; i++) {
                            var s = n.nodes[i];
                            t[i * 2 + 1] = s.position[0],
                            t[i * 2 + 2] = s.position[1]
                        }
                        t[0] = n._token
                    }
    ...
    function(t) {
        ...
        var n = t("zrender/tool/vector"),
        r = typeof Float32Array == "undefined" ? Array: Float32Array;
        return i.prototype.beforeUpdate = function() {
        ...
        u.prototype.initNodes = function(e, t, n) {
            this.temperature = 1;
            var r = e.length / 2;
            this.nodes.length = 0;
        ...
        u.prototype.initEdges = function(e, t) {
            var n = e.length / 2;
            this.edges.length = 0;
        ...
        u.prototype.update = function() {
            ...
            for (var t = 0; t < e; t++) {
                ...
                if (p > 0) {
                    ...
                    d > 0 && (p = Math.min(p / d, 1) * d, n.scaleAndAdd(l, s.speedPrev, f, p))
                }
                var v = n.len(l),
...
function(e) {
    ...
    return g.prototype = {
        ...
        _preProcessData: function(e) {
            ...
            r = 0,
            i = this;
            this._filteredNodes = S(this._rawNodes,
            function(e, s) {
                if (!e) return;
                if (e.ignore) return;
                var o = -1;
            ...
            var s, o;
            this._filteredLinks = S(this._rawLinks,
            function(e, r) {
                s = e.source,
                o = e.target;
                var i = !0,
        ...
        _initLayout: function(e) {
            ...
            for (var g = 0; g < i; g++) {
                ...
                var N = r[g].style;
                N.width = N.width || v[g] * 2,
                N.height = N.height || v[g] * 2,
                N.x = -N.width / 2,
                N.y = -N.height / 2,
                r[g].position = T,
                x[g * 2] = T[0],
            ...
            this._layoutWorker ? (this._token = m(), this._layoutWorker.postMessage({
                cmd: "init",
                nodesPosition: x,
                nodesMass: S,
                nodesSize: v,
                ...
                cmd: "updateConfig",
                config: A
            })) : (a.merge(this._layout, A, !0), this._layout.initNodes(x, S, v), this._layout.initEdges(C, k))
        },
