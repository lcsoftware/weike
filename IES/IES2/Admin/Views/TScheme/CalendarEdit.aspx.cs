...
namespace Admin.Views.TScheme
{
    public partial class CalendarEdit : System.Web.UI.Page
    {
        ...
        public void DataBinder()
        {
            ...
            this.Termn.SelectedValue = list.term.TermTypeID.ToString();
        ...
        public void Update()
        {
            ...
            string lname = Request["ln" + i].ToString();
            TimeSpan stime = TimeSpan.Parse(Request["st" + i].ToString());
            TimeSpan etime = TimeSpan.Parse(Request["et" + i].ToString());
            ...
            if (i != 0)
            {
                IES.JW.Model.Lesson lesson = new IES.JW.Model.Lesson { LessonID = i, LessonName = lname, StartTime = stime, EndTime = etime, Duration = duration };
        ...
        protected void btnInfo_Click(object sender, EventArgs e)
        {
            ...
            IES.JW.Model.Lesson _term = new IES.JW.Model.Lesson { LessonID = id };
            IES.G2S.JW.BLL.TermBLL termbll = new IES.G2S.JW.BLL.TermBLL();
            bool result = termbll.Lesson_Del(_term);
            if (result == true)
            { DataBinder(); }
        }
        ...
        protected void update_Click(object sender, EventArgs e)
        {
            int id = Sumbit();
            if (id != 0)
                Response.Write("<script>alert('操作成功');location.href='Calendar.aspx';</script>");
        }
    }
}