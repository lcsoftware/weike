<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Student.aspx.cs" Inherits="Admin.Views.Resource.Video.Student" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="data_nav_box">
        <ul class="data_nav_list">
            ...
            <li><a href="#">教师上传</a></li>
            <li class="active"><a href="#">学生上传</a></li>
            <li><a href="#">推荐视频</a></li>
        </ul>
    </div>
