...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="sousuo_box">
        <div class="filter_item">
            <a class="add_student" href="javascript:ADD();" style="margin-right: 15px"><i class="icon_admin add_btn"></i>新增指南</a>
            <p class="search_btn">
                <input id="Key" runat="server" type="text" placeholder="输入主题搜索使用指南"><a runat="server" style="float: right; position: relative; margin-right: 3px; margin-top: -23px;" onserverclick="btnSelect_Click" class="icon_admin search_icon"></a>
            </p>
        </div>
    </div>
                    ...
                    <tr class="item item_row" id="<%#Eval("HelpID")%>">
                        ...
                        <td>
                            <p class='operation_box'>
                                ...
                                <i title='删除' id='<%#Eval("HelpID")%>' onclick="Del(this.id)" class='icon_admin delete_btn'></i>
                            </p>
                        </td>
                    </tr>
                </ItemTemplate>
