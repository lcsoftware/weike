    ...
    <script src="../Edit.js"></script>
     ...
     <div class="search_result_box">
        <div class="result_tit">
            ...
            <select id="sel_pageSize"  onchange="GetListChange(this)">
                <option>10</option>
                <option>15</option>
                <option>20</option>
            </select></p>
        ...
        <asp:Repeater ID="Repeater1" runat="server">
            ...
            <ItemTemplate>
                <tr class="item item_row" id="<%#Eval("NoticeID")%>">
                    ...
                    <td>
                        <label><%#Eval("UserID")%></label></td>
                    <td>
                        <p class='operation_box'>
                            <i title='编辑' pid='<%#Eval("NoticeID")%>' onclick='Edit(this)' class='icon_admin edit_btn'></i>
                            <i title='删除' id='<%#Eval("NoticeID")%>' onclick="Del(this.id)" class='icon_admin delete_btn'></i></p></td>
                    </td>
                </tr>
            </ItemTemplate>
            <SeparatorTemplate>
