<%@ Page Language="C#"  MasterPageFile="~/Site.Master"  AutoEventWireup="true" CodeBehind="CourseType.aspx.cs" Inherits="Admin.Views.JW.Course.CourseType" %>
...
<asp:content id="Content1" contentplaceholderid="MainContent" runat="server">
    ...
    <script src="../../../Frameworks/zTree_v3/js/CourseTypeTree.js"></script>
    ...
    <div class="sousuo_box">
        <div class="filter_item">
            ...
            <a class="add_student" href="javascript:ShowBox(0,'无',0);"><i class="icon_admin add_btn"></i>新增分类</a>
            <p class="search_btn">
                <input type="text" id="key" placeholder="输入编号、名称搜索分类"><i class="icon_admin search_icon"></i>
            </p>
        </div>
    </div>
	...
	<div class="wrap_box" style="margin:0">
    	<div class="add_box">
            <dl class="add_item">
                ...
                <dd>
                    <div class="num_box">	
                        <input type="text" value="1" name="CourseTypeNo">
                        <span>*</span>
                        <p style="display: none;" id="regMsg"><i class="icon_admin wrong_icon"></i>编号已存在</p> 
                        <p style="display: none;" id="NoMsg"><i class="icon_admin wrong_icon"></i>请输入分类编号</p>                          
                    </div>
                </dd>
            </dl>
            <dl class="add_item">
                ...
                <dd>
                    ...
                    <span>*</span> 
                    <p style="display: none;" id="NameMsg"><i class="icon_admin wrong_icon"></i>请输入分类名称</p> 
                        </div> 
                </dd>
            </dl>
            <dl class="add_item">
                <dt>上级分类：</dt>
                <dd>
                     <select name="CourseType" class="department_select" style="width: 180px;height:30px">
                     </select>
                </dd>
            </dl>           
        </div>
