<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddCourse.aspx.cs" Inherits="Admin.Views.ADD.AddCourse" %>
        ...
        <div>
            <div class="filter_item">
                <p class="search_btn" style="float: right; margin: 3px">
                    <input id="txtKey" runat="server" type="text" placeholder="请输入编号,课程名称搜索" /><a runat="server" style="float: right; position: relative; margin-right: 3px; margin-top: -25px; z-index: 999" onclick="ParmSelect()" class="icon_admin search_icon"></a>
                </p>
            </div>
            <div id="div_tea" style="margin-top: 20px;">
                ...
                <div style="float: left; border: 1px solid #ccc; height: 310px; width: 700px; margin-left: 20px;">
                    ...
                    <div id="courseList" style="height: 280px; overflow-y: auto; overflow-x: hidden;">
                    </div>
