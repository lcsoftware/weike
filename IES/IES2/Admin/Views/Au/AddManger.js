...
function GetTeacherList() {
    ...
    strHtml += "            <td>所属机构</td>";
    strHtml += "      </tr>";
    var data = { action: "GetTeacherList", Key: $("#txtKey").val(), OrganizationID: OrganizationID, PageSize: 10, PageIndex: PageIndex };
    var stuList = $G2S.GetAjaxJson(data, "AddManger.ashx");
    if (stuList != "暂无数据") {
        for (var i = 0; i < stuList.length; i++) {
            ...
            strHtml += "    <td style='float: right; '><input type='checkbox' onclick='' name='ckbItem' pid='" + UserID + "' sname='" + Name + "' class='ckbcss'/></td>";
            strHtml += "    <td></td>";
