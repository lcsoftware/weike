...
using IES.G2S.CourseRun.IBLL.Forum  ;
using IES.G2S.CourseRun.DAL.Forum;
...
namespace IES.G2S.CourseRun.BLL
{
    public class FourmBLL: IForumBLL 
    {
        ...
        {
            return FourmDAL.ForumTopicType_Del(id);
        }
        ...
        /// <returns></returns>
        public ForumTopicInfo ForumTopic_Info_Get(int id)
        {
            return FourmDAL.ForumTopic_Info_Get(id);
        }
