...
namespace IES.G2S.CourseRun.DAL.Forum
{
    public class FourmDAL
    {
        ...
        public static ForumTopicType ForumTopicType_Upd(ForumTopicType model)
        {
            return new ForumTopicType();
        }
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        public static bool ForumTopicType_Del(int id)
        {
            try
            {
        ...
        /// <returns></returns>
        public static ForumTopicInfo ForumTopic_Info_Get(int id)
        {
